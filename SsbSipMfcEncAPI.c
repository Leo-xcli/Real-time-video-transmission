...
void *SsbSipMfcEncOpen(void)
{
    ...
    pCTX->v4l2_enc.bInputPhyVir = 0; //1
...
SSBSIP_MFC_ERROR_CODE SsbSipMfcEncInit(void *openHandle, void *param)
{
    ...
    default:
        printf("[%s] Undefined codec type",__func__);
        ret = MFC_RET_INVALID_PARAM;
        goto error_case1;
    }
    ...
    case H263_ENC:
        ...
        break;
    default:
        printf("[%s] Codec has not been recognised",__func__);
...
#endif
    default:
        printf("[%s] conf_type(%d) is NOT supported\n",__func__, conf_type);
        return MFC_RET_INVALID_PARAM;
    }
